...
class SoftInquiry extends StatefulWidget {
  const SoftInquiry({Key? key}) : super(key: key);

  @override
  State<SoftInquiry> createState() => _SoftInquiryState();
}

class _SoftInquiryState extends State<SoftInquiry> {
  @override
